...
app_publisher = "Praful_D"
app_description = "Manage gym members, subscriptions, and payments"
...
scheduler_events = {
	...
	"daily": [
        "gym_management.gym_management.doctype.membership.membership_utils.expire_memberships"
